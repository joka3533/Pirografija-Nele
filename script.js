...
const obj1 = piray.push(new Piro("Sveti Vasilije Ostroški", "gallery/pic1.jpg", "ikone", "29,7x21cm ", 2500));
...
const obj4 = piray.push(new Piro("Sveti Stefan", "gallery/pic4.jpg", "ikone", "26x17cm", 4000));
...
const obj7 = piray.push(new Piro("Pesma", "gallery/pic7.jpg", "ukrasi personal", "A4", 3000));
const obj8 = piray.push(new Piro("Sveti Vasilije Ostroški", "gallery/pic8.jpg", "ikone", "26x17cm", 6000));
const obj9 = piray.push(new Piro("Sveti Avramije", "gallery/pic9.jpg", "ikone", "26x17cm", 4000));
...
const obj16 = piray.push(new Piro("Kuhinjska daska", "gallery/pic16.png", "kuca", "mala", 600));
const obj17 = piray.push(new Piro("Kuhinjska daska", "gallery/pic17.png", "kuca", "velika", 800));
const obj18 = piray.push(new Piro("Podmetač za čaše Ruže", "gallery/pic18.png", "kuca", "9,5x9,5cm", 200, "/kom"));
const obj19 = piray.push(new Piro("Sv Nikola - Blagoslov", "gallery/pic19.png", "ikone", "36,5x13,5cm", 4000));
const obj20 = piray.push(new Piro("Sunđer Bob magnet", "gallery/pic20.png", "ukrasi deca slike", "9,5x6,5cm", 300));
...
const obj27 = piray.push(new Piro("Podmetač za čaše Ruža", "gallery/pic27.png", "kuca", "10cm", 200, "/kom"));
...
const obj30 = piray.push(new Piro("Kuhinjska daska", "gallery/pic30.png", "kuca", "mala", 600));
...
const obj41 = piray.push(new Piro("Sv Vasilije Ostroški, Blagoslov", "gallery/pic41.png", "ikone", "35x19cm", 5000));
...
const obj47 = piray.push(new Piro("Podmetač za čaše Ptica", "gallery/pic47.png", "kuca", "9,5x9,5cm", 200, "/kom"));
